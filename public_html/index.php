...
<html lang="en">
	...
	<body>
		<div id="top" class="container container-fluid d-flex align-items-center justify-content-center hero">
		...
		<div class="container-fluid d-flex justify-content-center middle">
		...
		<div class="fluid-container main-container mb-3">
			<div class="col-md-5 m-auto">
				<form id="form" role="form" action="php/mailer.php" method="post">
					...
					<div class="g-recaptcha" data-sitekey="6Lems30UAAAAAPll2lwRIV3XsfPe0I_r6bkzq8a3"></div>
				</form>
				<div class="row">
					<div class="col-xs-12">
